...
interface LinkedInExperienceProps {
  profileUrl: string;
  imagePath: string;
  name: string;
  headline: string;
...
export const LinkedInExperience: React.FC<LinkedInExperienceProps> = ({
  profileUrl,
  imagePath,
  name,
  headline,
  ...
  return (
    <div className="shadow-lg rounded-2xl text-center">
      <div className="flex items-center justify-between py-1 px-6 bg-gray-200 h-fit w-full">
        <LinkedInSVG />
        <Image
          src={imagePath}
          alt={name}
      ...
      <div className="px-4 py-2 flex flex-col items-center">
        <h3 className="font-semibold pt-1">{name}</h3>
        <p className="text-sm pt-1">{headline}</p>
...
export const LinkedInRecPage: React.FC<LinkedInExperienceProps> = ({
  profileUrl,
  imagePath,
  name,
  headline,
  ...
  return (
    <div className="shadow-lg rounded-2xl text-center bg-gray-100">
      <div className="flex items-center justify-between py-1 px-6 bg-gray-200 h-fit w-full rounded-t-2xl md:justify-center md:space-x-4">
        <LinkedInSVG />
        <Image
          src={imagePath}
          alt={name}
  ...
  return (
    <div className="">
      <svg
        ...
        className="h-6 w-auto fill-current text-blue-500"
      >
        ...
        <g fill="currentColor">
          ...
          <path d="M16,8 L18.827,8 L18.827,9.441 L18.858,9.441 C19.289,8.664 20.562,7.875 22.136,7.875 C25.157,7.875 26,9.792 26,12.45 L26,18 L23,18 L23,12.997 C23,11.525 22.469,10.5 21.227,10.5 C19.719,10.5 19,11.694 19,13.197 L19,18 L16,18 L16,8 Z" />
          <path d="M11,18 L14,18 L14,8 L11,8 L11,18 Z M12.501,6.3 C13.495,6.3 14.3,5.494 14.3,4.5 C14.3,3.506 13.495,2.7 12.501,2.7 C11.508,2.7 10.7,3.506 10.7,4.5 C10.7,5.494 11.508,6.3 12.501,6.3 Z" />
